        ...
        <Grid fluid className="valign-wrapper">
          <Row>
            <Col xs={12} sm={10} md={8} className="about__content">
              ...
              <div className="m-b-sm">
                <a className="accent m-b-sm no-underline" href="mailto:debashishzero@gmail.com">
              ...
              <div className="m-b-sm">
                <Row>
                  <Col xs={2}>
                    <a href="https://github.com/theindianotaku">
                      <Github />
                    </a>
                  </Col>
                  <Col xs={2}>
                    <a href="https://www.linkedin.com/in/debashishnayak/">
                      <Linkedin />
                    </a>
                  </Col>
                  <Col xs={2}>
                    <a href="https://www.instagram.com/debashish.nayak/">
                      <Instagram />
                    </a>
                  </Col>
                  <Col xs={2}>
                    <a href="https://twitter.com/theindian0taku">
                      <Twitter />
                    </a>
                  </Col>
                  <Col xs={2}>
                    <a href="https://twitter.com/theindian0taku" className="no-underline">
