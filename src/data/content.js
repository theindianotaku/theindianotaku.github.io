...
export const projects = [
  {
    ...
    short: 'Re-design and re-structure of Core Channeli to a React + Redux stack',
    ...
    description: "They invented hugs to let people know you love them without saying anything. Likewise, we invented Connect-e-dil. As the tradition goes, send roses, make connections and spread the ❤. If there was a couple meant to be, one can go ahead and suggest a match using the 'Make a Pair feature'. This app had to be built within 3 days, and we succeeded in doing so. It was built using React+Redux and also had a real-time shoutbox feature, built with Sockets. The app had almost 4.5K registered users and more than 30K pageviews.",
    short: "A fun app launched during the Valentines' Week where one could send roses and nominate couples",
    image: 'https://github.com/theindianotaku/portfolio-assets/blob/master/projects/01-hero.jpg?raw=true',
    theme: '#f56a7f'
  }, {
    id: 3,
    ...
    short: 'An online portal to facilitate Channeli Registration of the freshers, which in the previous years was a tedious paperwork',
    image: 'https://github.com/theindianotaku/portfolio-assets/blob/master/projects/01-hero.jpg?raw=true',
    theme: '#f56a7f'
  }, {
    id: 4,
    ...
    short: 'A platform to help the freshers get a proper insight about the Institute by providing a medium for them to interact with existing students and authorities.',
    image: 'https://github.com/theindianotaku/portfolio-assets/blob/master/projects/01-hero.jpg?raw=true',
    theme: '#f56a7f'
  }, {
    id: 5,
    ...
    short: 'Portfolio showcasing the projects and case studies taken up by IIT Roorkee Chapter of Unnat Bharat Abhiyan',
    image: 'https://github.com/theindianotaku/portfolio-assets/blob/master/projects/01-hero.jpg?raw=true',
    theme: '#f56a7f'
  }, {
    id: 6,
    ...
    short: 'Promotional website for the recruitment drive of Information Management Group',
    image: 'https://github.com/theindianotaku/portfolio-assets/blob/master/projects/01-hero.jpg?raw=true',
    theme: '#f56a7f'
  }, {
    id: 7,
    ...
    short: 'Helpdesk comprises of well-documented FAQs and currently facing/unresolved issues of the services in Channeli',
    ...
    short: 'Channeli Noticeboard is a medium for the students to access the notices posted by various institute authorities',
    image: 'https://github.com/theindianotaku/portfolio-assets/blob/master/projects/01-hero.jpg?raw=true',
    theme: '#f56a7f'
  }
];
